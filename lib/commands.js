    ...
    after: {
        ...
        about: function(details, next) {
            ...
            if (info) {                
                ...
                di.log.info('Platform: ' + yellow(info.platform));
                di.log.info('Build Date: ' + yellow(info.date));
                di.log.info('Revision Number: ' + yellow(info.source));
                di.log.info('Authenticated Session Timeout: ' + 
                    yellow(info.authenticatedSessionTimeout));
                di.log.info('Anonymous Session Timeout: ' + 
                    yellow(info.anonymousSessionTimeout));               
            } else {
